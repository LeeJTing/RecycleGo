...
class _AdminDetailScreenState extends State<AdminDetailScreen> {
  ...
  Future<void> _updateAdmin() async {
    ...
    try {
      ...
      await ctrl.updateName(widget.admin.adminId!, _usernameController.text.trim());
        ...
        actions: [
          Consumer<AdminProvider>(
            builder: (context, adminProvider, _) {
              final isSelf = adminProvider.admin?.adminId == widget.admin.adminId;
              if (isSelf) return const SizedBox.shrink();
              
              return IconButton(
                icon: Icon(_isEditing ? Icons.close : Icons.edit, color: theme.primary),
        ...
        child: Column(
          ...
          children: [
            ...
            if (!_isEditing) ...[
              ...
              Text(widget.admin.email, style: TextDesign.normalText(color: theme.hint)),
            ] else ...[
            ...
            if (!_isEditing) ...[
              ...
              _buildDetailTile(
                ...
                theme: theme,
                valueColor: _selectedStatus == 'active' ? theme.success : theme.error,
              ),
            ] else ...[
              _buildEditDropdown(
                icon: Icons.admin_panel_settings_outlined,
            ...
            _buildDetailTile(
              ...
              label: "Created At",
              value: widget.admin.createdAt != null ? formatter.format(widget.admin.createdAt!) : "N/A",
              theme: theme,
            ),
            if (_isEditing) ...[
              const SizedBox(height: 32),
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: _isLoading 
                    ...
                    : Text("Save Changes", style: TextDesign.buttonText(color: theme.onPrimary)),
                ),
              ),
            ],
          ],
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  value,
                  style: TextDesign.normalText(color: valueColor ?? theme.onSurface).copyWith(fontWeight: FontWeight.bold),
                ),
              ],
            ),
          ),
              ...
              children: [
                ...
                DropdownButtonHideUnderline(
                  child: DropdownButton<String>(
                    ...
                    style: TextDesign.normalText(color: theme.onSurface).copyWith(fontWeight: FontWeight.bold),
                    onChanged: onChanged,
